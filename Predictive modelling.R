...
#load dataset
Data<-read_excel("C:/Users/Sakshi saraiya/OneDrive/Desktop/Loan Prediction Dataset.xlsx")
View(Data)
...
# Ensure predicted_class and Loan_Status are factors
testData$predicted_class <- as.factor(testData$predicted_class)
testData$Loan_Status <- as.factor(testData$Loan_Status)
# Generate the confusion matrix
library(caret) 
Confusion_Matrix <- confusionMatrix(testData$predicted_class, testData$Loan_Status)
